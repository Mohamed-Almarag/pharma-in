<template>
  <div class="view-padding">
    ...
    <DescriptionPages bgImage="newsImage">
      <template #title>
        <div>
          <h2 class="title-page text-capitalize">{{ $t("event.all news") }}</h2>
        </div>
      </template>
    </DescriptionPages>
          ...
          >
            <div class="card-container">
              <div class="cover-photo shadow">
                ...
                >
                  <router-link
                    @click.native="calculateNewsVisitedTimes(item.id)"
                    class="
                      single-details
                      item-details
                      rounded-circle
                      ...
                      text-center
                    "
                    :to="`/events-and-news/all-news/${item.id}`"
